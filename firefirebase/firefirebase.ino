...
const String USER = "wap";
const String PASS = "wap123";

const String FIREBASE_HOST  = "sim800lagi-default-rtdb.asia-southeast1.firebasedatabase.app/";
const String FIREBASE_SECRET  = "C1fy7JgZjg0rRxqxp7q2ostYt7a0iQlytjjVKUhc";
